<?php   
    ...
    if(isset($_POST['usuario']) && isset($_POST['usuario'])){
        ...
        $sql="SELECT id,usuario AS nombre,correo AS password FROM profesors WHERE correo='$usuario' AND usuario='$password'";
            ...
            <div class="col-lg-4 col-md-4 col-sm-8 col-xl-4" id="formul">
                <form action="login_prof.php" method="post">
                    <div class="form-login">
                        <div class="row">
                            <div class="col-2">
                                <center><i class='fa fa-users fa-lg' aria-hidden='true'></i></center>
                            </div>
                            <div class="col-8">
